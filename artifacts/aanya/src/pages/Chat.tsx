...
import { Send, Mic, Phone, PhoneOff, Settings, X, Check } from "lucide-react";
      ...
      <AnimatePresence>
        {showSettings && (
          <motion.div
            ...
            className="bg-card/95 border-b border-primary/20 px-5 py-4 backdrop-blur-xl z-10 shrink-0"
          >
